if (NOT MEASUREMENTKIT_FOUND)
    ...
    # Find the library
    find_library (MEASUREMENTKIT_LIBRARY measurement_kit
    ...
    find_package_handle_standard_args(MeasurementKit
        DEFAULT_MSG
...
if(MEASUREMENTKIT_FOUND)
    set(MEASUREMENTKIT_LIBRARIES ${MEASUREMENTKIT_LIBRARY})
    set(MEASUREMENTKIT_INCLUDE_DIRS ${MEASUREMENTKIT_INCLUDE_DIR})
endif()

mark_as_advanced(MEASUREMENTKIT_LIBRARY
	MEASUREMENTKIT_INCLUDE_DIR)
