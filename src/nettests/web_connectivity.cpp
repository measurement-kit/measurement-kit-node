...
void WebConnectivityTest::SetOutputFilepath(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void WebConnectivityTest::Start(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
