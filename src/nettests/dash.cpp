...
void DashTest::OnEntry(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void DashTest::OnEvent(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void DashTest::OnEnd(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void DashTest::OnBegin(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void DashTest::SetErrorFilepath(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void DashTest::SetOutputFilepath(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
...
void DashTest::Start(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  assert(info.Length() >= 1);
